      ...
      <el-table-column label="状态" width="100">
        <template slot-scope="item">
          <div>
            ...
            <el-button v-if="item.row.status == 1" type="success" size="small"
              >启用</el-button
            >
...
export default {
  ...
  methods: {
    ...mapActions({
      ...
      getCounts: "goodsinfo/getCount", //获取总条数
  ...
  computed: {
    ...mapGetters({
      ...
      getCount: "goodsinfo/getCount", //总条数
      getSize: "goodsinfo/getSize", //当前显示条数
    }),
  },
  filters: {},
  components: {},
